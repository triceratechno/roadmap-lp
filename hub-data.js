  ...
  steps: [
    ...
    // ========== STEP 1 ==========
    {
      ...
      articles: [
        ...
        { id: "1-2", type: "lesson", title: "STEP1-2：レファレンスを丸裸にする ── AIステム分離で、プロの設計図を読み解く", pageUrl: "articles/step1-2.html", noteUrl: "https://note.com/preview/nc2001a80fe23?prev_access_key=e6acca3e5743e3250683ec1447a0121b", pdfUrl: "step1-2.pdf", videoUrl: "", status: "published" },
    ...
    // ========== STEP 2 ==========
    {
      ...
      status: "completed",
      articles: [
        { id: "2-overview", type: "overview", title: "STEP2 全体解説：ローエンドは\"音作り\"じゃない。設計で9割決まる。", pageUrl: "articles/step2-overview.html", noteUrl: "https://note.com/preview/n05af5b6c71bb?prev_access_key=42a01a4c18a54837b4562495b37727ff", pdfUrl: "step2_overview.pdf", videoUrl: "https://note.com/preview/nebb2b55edafa?prev_access_key=57c45be6df3374406f2299442c6d8ac1", status: "published" },
